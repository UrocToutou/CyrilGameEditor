#include "pch.h"
#include "CyrilGameEditorMain.h"
#include "Common\DirectXHelper.h"

using namespace CyrilGameEditor;
using namespace Windows::Foundation;
using namespace Windows::System::Threading;
using namespace Concurrency;

// Charge et initialise les actifs de l'application lors de son chargement.
CyrilGameEditorMain::CyrilGameEditorMain(const std::shared_ptr<DX::DeviceResources>& deviceResources) :
...
CyrilGameEditorMain::~CyrilGameEditorMain()
{
...
void CyrilGameEditorMain::StopRenderLoop()
{
	m_renderLoopWorker->Cancel();
}

// Met à jour l'état de l'application une fois par frame.
void CyrilGameEditorMain::Update() 
{
	ProcessInput();
...
void CyrilGameEditorMain::ProcessInput()
{
...
bool CyrilGameEditorMain::Render() 
{
...
void CyrilGameEditorMain::OnDeviceLost()
{
...
void CyrilGameEditorMain::OnDeviceRestored()
{
