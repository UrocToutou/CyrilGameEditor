...
void DX::DeviceResources::CreateWindowSizeDependentResources() 
{
	...
	else
	{
		...
		swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_FLIP_SEQUENTIAL;	// Toutes les applications du Windows Store doivent utiliser _FLIP_ SwapEffects.
		...
		// Les modifications d'UI doivent être retransmises au thread d'UI
